...
with DAG(
    dag_id="DATA_CON_TRANSACTION_MOVE_FILE_ADHOC",
    ...
    MOVING_FILE_ARCHIVE_ADHOC = EzSparkSubmitOperator(
        spark_binary='spark-submit',
        application=f"s3a://notebooks/lakehouse/control/DTC_move_file_archive_adhoc.py",
        conn_id='spark_conn',
        task_id='Archive_DTC_file_adhoc',
        conf=conf,
        dag=dag
    )
    MOVING_FILE_ARCHIVE_ADHOC 
