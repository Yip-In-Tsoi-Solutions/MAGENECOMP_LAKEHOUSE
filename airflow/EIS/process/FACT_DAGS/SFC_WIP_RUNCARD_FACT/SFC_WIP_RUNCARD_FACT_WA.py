...
sourceFile="SFC_WIP_RUNCARD_FACT_WA_rerun.py"
...
with DAG(
    dag_id="SFC_WIP_RUNCARD_FACT_WA",
    ...
    SFC_WIP_RUNCARD_FACT_WA = EzSparkSubmitOperator(
        ...
        application=f"s3a://notebooks/lakehouse/process/FACT/SFC_WIP_RUNCARD_FACT/rerun/{sourceFile}",
        conn_id='spark_conn',
        task_id='SFC_WIP_RUNCARD_FACT_WA_rerun',
        conf={
