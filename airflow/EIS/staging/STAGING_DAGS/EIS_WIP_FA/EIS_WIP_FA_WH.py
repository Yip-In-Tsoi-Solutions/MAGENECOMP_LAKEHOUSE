...
sourceFile = "EIS_WIP_FA_WH_rerun.py"
...
with DAG(
    ...
    EIS_WIP_FA_WH = EzSparkSubmitOperator(
        ...
        application=f"s3a://notebooks/lakehouse/staging/EIS/EIS_WIP_FA/rerun/{sourceFile}",
        conn_id='spark_conn',
        task_id='EIS_WIP_FA_WH_rerun',
        conf={
