...
sourceFile = "EIS_WORK_WEEK_WA.py"
...
with DAG(
    ...
    # Define the task using EzSparkSubmitOperator
    EIS_WORK_WEEK_WA = EzSparkSubmitOperator(
        spark_binary='spark-submit',
        application=f"s3a://notebooks/lakehouse/staging/EIS/EIS_WORK_WEEK/{sourceFile}",
        conn_id='spark_conn',
        task_id='spark_jobs',
        conf={
