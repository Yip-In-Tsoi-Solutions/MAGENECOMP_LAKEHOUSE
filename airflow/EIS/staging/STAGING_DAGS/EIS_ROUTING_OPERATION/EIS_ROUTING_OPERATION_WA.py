...
sourceFile = "EIS_ROUTING_OPERATION_WA.py"
...
with DAG(
    dag_id="EIS_ROUTING_OPERATION_WA",
    ...
    EIS_ROUTING_OPERATION_WA = EzSparkSubmitOperator(
        ...
        application=f"s3a://notebooks/lakehouse/staging/EIS/EIS_ROUTING_OPERATION/{sourceFile}",
        conn_id='spark_conn',
        task_id='spark_jobs',
        conf={
