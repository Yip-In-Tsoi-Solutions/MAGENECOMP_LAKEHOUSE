...
sourceFile = "EIS_WIP_FA_START_OPERATION_WN.py"
...
with DAG(
    dag_id="EIS_WIP_FA_START_OPERATION_WN",
    ...
    EIS_WIP_FA_START_OPERATION_WN = EzSparkSubmitOperator(
        ...
        application=f"s3a://notebooks/lakehouse/staging/EIS/EIS_WIP_FA_START_OPERATION/{sourceFile}",
        conn_id='spark_conn',
        task_id='spark_jobs',
        conf={
