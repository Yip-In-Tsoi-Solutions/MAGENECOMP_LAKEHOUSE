...
sourceFile = "EIS_WIP_FA_WIP_TRANS_WA_rerun.py"
...
with DAG(
    dag_id="EIS_WIP_FA_WIP_TRANS_WA",
    default_args=default_args,
    description='Run DAG everyday at 7:00',
    schedule_interval='0 7 * * *', 
    catchup=False,
) as dag:
    EIS_WIP_FA_TRANS_WA = EzSparkSubmitOperator(
        spark_binary='spark-submit',
        application=f"s3a://notebooks/lakehouse/staging/EIS/EIS_WIP_FA_WIP_TRANS/rerun/{sourceFile}",
        conn_id='spark_conn',
        task_id='EIS_WIP_FA_WIP_TRANS_WA_rerun',
        conf={
