...
sourceFile="SFC_RUNCARD_DIM_WH_rerun.py"
...
with DAG(
    ...
    catchup=False,
     ...
     SFC_RUNCARD_DIM_WH = EzSparkSubmitOperator(
        ...
        application=f"s3a://notebooks/lakehouse/master/DIM/SFC_RUNCARD_DIM/rerun/{sourceFile}",
        conn_id='spark_conn',
        task_id='SFC_RUNCARD_DIM_WH_rerun',
        conf={
