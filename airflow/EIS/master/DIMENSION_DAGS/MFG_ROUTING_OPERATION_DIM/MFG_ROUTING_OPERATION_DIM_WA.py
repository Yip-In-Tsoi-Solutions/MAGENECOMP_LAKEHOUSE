...
sourceFile="MFG_ROUTING_OPERATION_DIM_WA.py"
...
with DAG(
    dag_id="MFG_ROUTING_OPERATION_DIM_WA",
    ...
    catchup=False,
     ...
     MFG_ROUTING_OPERATION_DIM_WA = EzSparkSubmitOperator(
        ...
        application=f"s3a://notebooks/lakehouse/master/DIM/MFG_ROUTING_OPERATION_DIM/{sourceFile}",
        conn_id='spark_conn',
        task_id='spark_jobs',
        conf={
