...
# Define variable confirm_initial_flag
...
#For check before run all task initial
def failing_task():
    if confirm_initial_flag == 'T':
        print("Process failing_task skipped.")
        ...
        raise Exception("Variable confirm_initial_flag is F")
...
with DAG(
    dag_id="WORKS_FLOWS_INITIAL",
    default_args=default_args,
    description='Clear & Load initial data',
    schedule_interval=None,
    catchup=False,
    concurrency=15,
    tags=['cum_yield', 'initial'],
) as dag:
    task1 = PythonOperator(
        task_id='failing_task',
        python_callable=failing_task
    )
    TRUNCATE_ALL_DATA = EzSparkSubmitOperator(
        spark_binary='spark-submit',
        application=f"s3a://notebooks/lakehouse/control/Truncate_all_datalakehouse.py",
        conn_id='spark_conn',
        task_id='TRUNCATE_ALL_DATA',
        conf={
            "spark.hadoop.fs.s3a.access.key": access_key,
            "spark.hadoop.fs.s3a.secret.key": secret_key,
            "spark.hadoop.fs.s3a.imp": "org.apache.hadoop.fs.s3a.S3AFileSystem",
    ...
    with TaskGroup("STAGING_WA_GROUP") as STAGING_WA_GROUP:
        ...
        EIS_WIP_FA_WA = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/staging/EIS/EIS_WIP_FA/initial/EIS_WIP_FA_WA_initial.py",
            conn_id='spark_conn',
        ...
        EIS_WIP_FA_WIP_TRANS_WA = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/staging/EIS/EIS_WIP_FA_WIP_TRANS/initial/EIS_WIP_FA_WIP_TRANS_WA_initial.py",
            conn_id='spark_conn',
    ...
    with TaskGroup("STAGING_WH_GROUP") as STAGING_WH_GROUP:
        ...
        EIS_WIP_FA_WH = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/staging/EIS/EIS_WIP_FA/initial/EIS_WIP_FA_WH_initial.py",
            conn_id='spark_conn',
        ...
        EIS_WIP_FA_WIP_TRANS_WH = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/staging/EIS/EIS_WIP_FA_WIP_TRANS/initial/EIS_WIP_FA_WIP_TRANS_WH_initial.py",
            conn_id='spark_conn',
    ...
    with TaskGroup("STAGING_WN_GROUP") as STAGING_WN_GROUP:
        ...
        EIS_WIP_FA_WN = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/staging/EIS/EIS_WIP_FA/initial/EIS_WIP_FA_WN_initial.py",
            conn_id='spark_conn',
        ...
        EIS_WIP_FA_WIP_TRANS_WN = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/staging/EIS/EIS_WIP_FA_WIP_TRANS/initial/EIS_WIP_FA_WIP_TRANS_WN_initial.py",
            conn_id='spark_conn',
    ...
    with TaskGroup("DIMENSION_DAGS_GROUPS_WA_1") as DIMENSION_DAGS_GROUPS_WA_1:
        ...
        MFG_PRODUCT_DIM_WA = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/master/DIM/MFG_PRODUCT_DIM/initial/MFG_PRODUCT_DIM_WA_initial.py",
            conn_id='spark_conn',
    ...
    with TaskGroup("DIMENSION_DAGS_GROUPS_WA_2") as DIMENSION_DAGS_GROUPS_WA_2:
        ...
        SFC_RUNCARD_DIM_WA = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/master/DIM/SFC_RUNCARD_DIM/initial/SFC_RUNCARD_DIM_WA_initial.py",
            conn_id='spark_conn',
    ...
    with TaskGroup("DIMENSION_DAGS_GROUPS_WH_1") as DIMENSION_DAGS_GROUPS_WH_1:
        ...
        MFG_PRODUCT_DIM_WH = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/master/DIM/MFG_PRODUCT_DIM/initial/MFG_PRODUCT_DIM_WH_initial.py",
            conn_id='spark_conn',
    ...
    with TaskGroup("DIMENSION_DAGS_GROUPS_WH_2") as DIMENSION_DAGS_GROUPS_WH_2:
        ...
        SFC_RUNCARD_DIM_WH = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/master/DIM/SFC_RUNCARD_DIM/initial/SFC_RUNCARD_DIM_WH_initial.py",
            conn_id='spark_conn',
    ...
    with TaskGroup("DIMENSION_DAGS_GROUPS_WN_1") as DIMENSION_DAGS_GROUPS_WN_1:
        ...
        MFG_PRODUCT_DIM_WN = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/master/DIM/MFG_PRODUCT_DIM/initial/MFG_PRODUCT_DIM_WN_initial.py",
            conn_id='spark_conn',
    ...
    with TaskGroup("DIMENSION_DAGS_GROUPS_WN_2") as DIMENSION_DAGS_GROUPS_WN_2:
        ...
        SFC_RUNCARD_DIM_WN = EzSparkSubmitOperator(
            spark_binary='spark-submit',
            application=f"s3a://notebooks/lakehouse/master/DIM/SFC_RUNCARD_DIM/initial/SFC_RUNCARD_DIM_WN_initial.py",
            conn_id='spark_conn',
    ...
    SFC_WIP_RUNCARD_FACT_WA = EzSparkSubmitOperator(
        spark_binary='spark-submit',
        application=f"s3a://notebooks/lakehouse/process/FACT/SFC_WIP_RUNCARD_FACT/initial/SFC_WIP_RUNCARD_FACT_WA_initial.py",
        conn_id='spark_conn',
    ...
    SFC_WIP_RUNCARD_FACT_WH = EzSparkSubmitOperator(
        spark_binary='spark-submit',
        application=f"s3a://notebooks/lakehouse/process/FACT/SFC_WIP_RUNCARD_FACT/initial/SFC_WIP_RUNCARD_FACT_WH_initial.py",
        conn_id='spark_conn',
    ...
    SFC_WIP_RUNCARD_FACT_WN = EzSparkSubmitOperator(
        spark_binary='spark-submit',
        application=f"s3a://notebooks/lakehouse/process/FACT/SFC_WIP_RUNCARD_FACT/initial/SFC_WIP_RUNCARD_FACT_WN_initial.py",
        conn_id='spark_conn',
    ...
    task1 >> TRUNCATE_ALL_DATA
    TRUNCATE_ALL_DATA >> [STAGING_WN_GROUP,STAGING_WH_GROUP,STAGING_WA_GROUP]
