...
appName = "EIS_PRODUCT_OVERALL_WN"
tableName = "lakehouse.EIS.EIS_PRODUCT_OVERALL_WN"
...
df = spark.read\
    ...
    .option("dbtable", "EIS.EIS_PRODUCT_OVERALL") \
    .option("user", oracleUser) \
    .option("password", oraclePass) \
    .option("driver", "oracle.jdbc.driver.OracleDriver") \
    .load()
df.createOrReplaceTempView("EIS_PRODUCT_OVERALL_WN")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_PRODUCT_OVERALL_WH' as INF_SESS_NAME,
