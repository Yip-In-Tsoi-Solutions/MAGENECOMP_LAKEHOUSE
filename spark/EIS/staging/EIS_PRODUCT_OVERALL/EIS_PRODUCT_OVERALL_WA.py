...
appName = "EIS_PRODUCT_OVERALL_WA"
tableName = "lakehouse.EIS.EIS_PRODUCT_OVERALL_WA"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_PRODUCT_OVERALL_WA")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_PRODUCT_OVERALL_WA' as INF_SESS_NAME,
