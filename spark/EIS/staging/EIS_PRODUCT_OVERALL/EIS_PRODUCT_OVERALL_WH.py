...
appName = "EIS_PRODUCT_OVERALL_WH"
tableName = "lakehouse.EIS.EIS_PRODUCT_OVERALL_WH"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_PRODUCT_OVERALL_WH")
