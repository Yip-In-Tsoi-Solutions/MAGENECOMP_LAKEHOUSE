...
appName = "EIS_WORK_WEEK_WN"
tableName = "lakehouse.EIS.EIS_WORK_WEEK_WN"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_WORK_WEEK_WN")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_WORK_WEEK_WN' as INF_SESS_NAME,
