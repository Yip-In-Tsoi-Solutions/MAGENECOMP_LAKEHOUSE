...
appName = "EIS_WORK_WEEK_WH"
tableName = "lakehouse.EIS.EIS_WORK_WEEK_WH"
...
df = spark.read\
    ...
    .option("dbtable", "EIS.EIS_WORK_WEEK") \
    .option("user", oracleUser) \
    .option("password", oraclePass) \
    .option("driver", "oracle.jdbc.driver.OracleDriver") \
    .load()
df.createOrReplaceTempView("EIS_WORK_WEEK_WH")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_WORK_WEEK_WH' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_WORK_WEEK_WH' as INF_SESS_NAME,
