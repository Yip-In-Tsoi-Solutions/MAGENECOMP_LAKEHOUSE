...
appName = "EIS_WORK_WEEK_WA"
tableName = "lakehouse.EIS.EIS_WORK_WEEK_WA"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_WORK_WEEK_WA")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_WORK_WEEK_WA' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_WORK_WEEK_WA' as INF_SESS_NAME,
