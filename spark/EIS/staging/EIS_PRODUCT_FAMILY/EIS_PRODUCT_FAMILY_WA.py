...
appName = "EIS_PRODUCT_FAMILY_WA"
tableName = f"lakehouse.EIS.EIS_PRODUCT_FAMILY_WA"
...
df = spark.read\
    ...
    .option("dbtable", "EIS.EIS_PRODUCT_FAMILY") \
    .option("user", oracleUser) \
    .option("password", oraclePass) \
    .option("driver", "oracle.jdbc.driver.OracleDriver") \
    .load()
df.createOrReplaceTempView("EIS_PRODUCT_FAMILY_WA")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_PRODUCT_FAMILY_WA' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_PRODUCT_FAMILY_WA' as INF_SESS_NAME,
