...
appName = "EIS_PRODUCT_FAMILY_WN"
tableName = "lakehouse.EIS.EIS_PRODUCT_FAMILY_WN"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_PRODUCT_FAMILY_WN")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_PRODUCT_FAMILY_WN' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_PRODUCT_FAMILY_WN' as INF_SESS_NAME,
