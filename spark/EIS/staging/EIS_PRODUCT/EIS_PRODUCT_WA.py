...
appName = "EIS_PRODUCT_WA"
tableName = "lakehouse.EIS.EIS_PRODUCT_WA"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_PRODUCT_WA")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_PRODUCT_WA' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_PRODUCT_WA' as INF_SESS_NAME,
