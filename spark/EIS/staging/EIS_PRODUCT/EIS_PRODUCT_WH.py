...
appName = "EIS_PRODUCT_WH"
tableName = "lakehouse.EIS.EIS_PRODUCT_WH"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_PRODUCT_WH")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_PRODUCT_WH' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_PRODUCT_WH' as INF_SESS_NAME,
