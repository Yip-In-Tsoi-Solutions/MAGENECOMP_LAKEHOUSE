...
appName = "EIS_PRODUCT_PART_WN"
tableName = "lakehouse.EIS.EIS_PRODUCT_PART_WN"
...
df = spark.read\
    ...
    .option("dbtable", "EIS.EIS_PRODUCT_PART") \
    .option("user", oracleUser) \
    .option("password", oraclePass) \
    .option("driver", "oracle.jdbc.driver.OracleDriver") \
    .load()
df.createOrReplaceTempView("EIS_PRODUCT_PART_WN")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_PRODUCT_PART_WN' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_PRODUCT_PART_WN' as INF_SESS_NAME,
