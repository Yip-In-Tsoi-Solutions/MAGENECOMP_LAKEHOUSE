...
appName = "EIS_JIT_CELL_WH"
tableName = "lakehouse.EIS.EIS_JIT_CELL_WH"
...
df = spark.read\
    ...
    .option("dbtable", "EIS.EIS_JIT_CELL") \
    .option("user", oracleUser) \
    .option("password", oraclePass) \
    .option("driver", "oracle.jdbc.driver.OracleDriver") \
    .load()
df.createOrReplaceTempView("EIS_JIT_CELL_WH")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_JIT_CELL_WH' as INF_SESS_NAME,
