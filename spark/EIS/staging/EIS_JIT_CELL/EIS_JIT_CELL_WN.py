...
appName = "EIS_JIT_CELL_WN"
tableName = "lakehouse.EIS.EIS_JIT_CELL_WN"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_JIT_CELL_WN")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_JIT_CELL_WN' as INF_SESS_NAME,
