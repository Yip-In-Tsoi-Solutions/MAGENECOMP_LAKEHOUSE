...
appName = "EIS_JIT_CELL_WA"
tableName = "lakehouse.EIS.EIS_JIT_CELL_WA"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_JIT_CELL_WA")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_JIT_CELL_WA' as INF_SESS_NAME,
