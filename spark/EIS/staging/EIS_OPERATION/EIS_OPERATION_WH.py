...
appName = "EIS_OPERATION_WH"
tableName = "lakehouse.EIS.EIS_OPERATION_WH"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_OPERATION_WH")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_OPERATION' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_OPERATION_WH' as INF_SESS_NAME,
