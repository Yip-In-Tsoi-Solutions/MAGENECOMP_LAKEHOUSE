...
appName = "EIS_OPERATION_WN"
tableName = "lakehouse.EIS.EIS_OPERATION_WN"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_OPERATION_WN")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_OPERATION_WN' as INF_SESS_NAME,
