...
appName = "EIS_ROUTING_OPERATION_WA"
tableName = f"lakehouse.EIS.EIS_ROUTING_OPERATION_WA"
...
df = spark.read\
    ...
    .option("dbtable", "EIS.EIS_ROUTING_OPERATION") \
    .option("user", oracleUser) \
    .option("password", oraclePass) \
    .option("driver", "oracle.jdbc.driver.OracleDriver") \
    .load()
df.createOrReplaceTempView("EIS_ROUTING_OPERATION_WA")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_ROUTING_OPERATION_WA' as INF_SESS_NAME,
