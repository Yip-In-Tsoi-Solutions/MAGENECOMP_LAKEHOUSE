...
appName = "EIS_ROUTING_OPERATION_WN"
tableName = f"lakehouse.EIS.EIS_ROUTING_OPERATION_WN"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_ROUTING_OPERATION_WN")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_ROUTING_OPERATION_WN' as INF_SESS_NAME,
