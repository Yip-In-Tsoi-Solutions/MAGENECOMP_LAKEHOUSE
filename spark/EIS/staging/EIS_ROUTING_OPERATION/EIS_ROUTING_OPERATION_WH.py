...
appName = "EIS_ROUTING_OPERATION_WH"
tableName = f"lakehouse.EIS.EIS_ROUTING_OPERATION_WH"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_ROUTING_OPERATION_WH")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_ROUTING_OPERATION_WH' as INF_SESS_NAME,
