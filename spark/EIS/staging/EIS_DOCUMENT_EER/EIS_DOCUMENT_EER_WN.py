...
appName = "EIS_DOCUMENT_EER_WN"
tableName = "lakehouse.EIS.EIS_DOCUMENT_EER_WN"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_DOCUMENT_EER_WN")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_DOCUMENT_EER_WN' as INF_SESS_NAME,
