...
appName = "EIS_DOCUMENT_EER_WA"
tableName = "lakehouse.EIS.EIS_DOCUMENT_EER_WA"
...
df = spark.read\
    ...
    .option("dbtable", "EIS.EIS_DOCUMENT_EER") \
    .option("user", oracleUser) \
    .option("password", oraclePass) \
    .option("driver", "oracle.jdbc.driver.OracleDriver") \
    .load()
df.createOrReplaceTempView("EIS_DOCUMENT_EER_WA")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_DOCUMENT_EER' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_DOCUMENT_EER_WA' as INF_SESS_NAME,
