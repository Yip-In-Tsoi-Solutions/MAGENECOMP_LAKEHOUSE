...
appName = "EIS_DOCUMENT_EER_WH"
tableName = "lakehouse.EIS.EIS_DOCUMENT_EER_WH"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_DOCUMENT_EER_WH")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_DOCUMENT_EER_WH' as INF_SESS_NAME,
