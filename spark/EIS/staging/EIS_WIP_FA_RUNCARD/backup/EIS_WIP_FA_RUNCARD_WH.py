...
appName = "EIS_WIP_FA_RUNCARD_WH"
tableName = f"lakehouse.EIS.EIS_WIP_FA_RUNCARD_WH"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_WIP_FA_RUNCARD_WH")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_WIP_FA_RUNCARD_WH' as INF_SESS_NAME,
