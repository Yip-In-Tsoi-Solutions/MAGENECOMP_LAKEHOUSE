...
appName = "EIS_WIP_FA_RUNCARD_WN"
tableName = f"lakehouse.EIS.EIS_WIP_FA_RUNCARD_WN"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_WIP_FA_RUNCARD_WN")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'Staging_EIS_WIP_FA_RUNCARD_WN' as INF_SESS_NAME,
