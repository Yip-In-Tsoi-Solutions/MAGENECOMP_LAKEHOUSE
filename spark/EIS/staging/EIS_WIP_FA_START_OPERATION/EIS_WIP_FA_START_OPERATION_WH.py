...
appName = "EIS_WIP_FA_START_OPERATION_WH"
tableName = f"lakehouse.EIS.EIS_WIP_FA_START_OPERATION_WH"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_WIP_FA_START_OPERATION_WH")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_WIP_FA_START_OPERATION_WH' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_WIP_FA_START_OPERATION_WH' as INF_SESS_NAME,
        ...
        FROM EIS_WIP_FA_START_OPERATION_WH
""")
