...
appName = "EIS_WIP_FA_START_OPERATION_WA"
tableName = f"lakehouse.EIS.EIS_WIP_FA_START_OPERATION_WA"
...
df = spark.read\
    ...
    .option("dbtable", "EIS.EIS_WIP_FA_START_OPERATION") \
    .option("user", oracleUser) \
    .option("password", oraclePass) \
    .option("driver", "oracle.jdbc.driver.OracleDriver") \
    .load()
df.createOrReplaceTempView("EIS_WIP_FA_START_OPERATION_WA")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_WIP_FA_START_OPERATION_WA' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_WIP_FA_START_OPERATION_WA' as INF_SESS_NAME,
        ...
        FROM EIS_WIP_FA_START_OPERATION_WA
""")
