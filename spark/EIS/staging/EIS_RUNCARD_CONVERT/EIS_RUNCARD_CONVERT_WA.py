...
appName = "EIS_RUNCARD_CONVERT_WA"
tableName = f"lakehouse.EIS.EIS_RUNCARD_CONVERT_WA"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_RUNCARD_CONVERT_WA")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_RUNCARD_CONVERT_WA' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_RUNCARD_CONVERT_WA' as INF_SESS_NAME,
