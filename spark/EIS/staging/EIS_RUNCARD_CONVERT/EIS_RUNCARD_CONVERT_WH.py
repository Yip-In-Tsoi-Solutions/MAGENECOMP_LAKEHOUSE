...
appName = "EIS_RUNCARD_CONVERT_WH"
tableName = f"lakehouse.EIS.EIS_RUNCARD_CONVERT_WH"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_RUNCARD_CONVERT_WH")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_RUNCARD_CONVERT_WH' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_RUNCARD_CONVERT_WH' as INF_SESS_NAME,
