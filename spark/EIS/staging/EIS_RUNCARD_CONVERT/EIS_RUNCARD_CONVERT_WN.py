...
appName = "EIS_RUNCARD_CONVERT_WN"
tableName = f"lakehouse.EIS.EIS_RUNCARD_CONVERT_WN"
...
df = spark.read\
    ...
    .load()
df.createOrReplaceTempView("EIS_RUNCARD_CONVERT_WN")
...
spark.sql(f"""
    ...
    SELECT 
        *,
        ...
        'EIS_RUNCARD_CONVERT_WN' as SOURCE_TABLE_NAME,
        {inf_batch_id} as INF_BATCH_ID,
        'Staging_EIS_RUNCARD_CONVERT_WN' as INF_SESS_NAME,
