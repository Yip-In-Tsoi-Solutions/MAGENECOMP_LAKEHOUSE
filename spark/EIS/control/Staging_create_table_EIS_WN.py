...
appName = "App_create_staging_table_wn"
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_PRODUCT_WN
  (
    PRODUCT_ID           	string,
	PROGRAM_NAME         	string,
	PRODUCT_TYPE         	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_PRODUCT_FAMILY_WN
  (
    FAMILY_PRODUCT_ID	string,
	FAMILY_NAME      	string,
	SORTING_TYPE     	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_PRODUCT_PART_WN
  (
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_PRODUCT_OVERALL_WN
  (
    PLANT            	string,
	PRODUCT_ID       	string,
	PROGRAM_NAME     	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_JIT_CELL_WN
  (
    JIT_CELL_NO                 	string,
	LINE_NO                     	string,
	ROOM                        	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_DOCUMENT_EER_WN
  (
    PRODUCT_PART_NO      	string,
	JIT_CELL_NO          	string,
	EERNO                	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_MACHINE_WN
  (
    MACHINE_NO             	string,
	MACHINE_NAME           	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_WORK_WEEK_WN
  (
    YEAR         	string,
	QUARTER      	string,
	MONTH        	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_WIP_FA_WN
  (
    PRODUCT_PART_NO   	string,
	RUN_NO            	string,
	OPERATION_NO      	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_WIP_FA_RUNCARD_WN
  (
    PRODUCT_PART_NO      	string,
	RUN_NO               	string,
	EER_NO               	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_WIP_FA_START_OPERATION_WN
  (
    PRODUCT_PART_NO	string,
	EER_NO         	string,
	OPERATION_NO   	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_WIP_FA_WIP_TRANS_WN
  (
    RUN_NO        	string,
	OPERATION_NO  	string,
	CYCLE_NO      	int,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_ROUTING_OPERATION_WN
  (
    PRODUCT_PART_NO         	string,
	EER_NO                  	string,
	OPERATION_NO            	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_OPERATION_WN
  (
    OPERATION_NO	string,
    AREA_NAME	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_RUNCARD_CONVERT_WN
  (
    RUN_NO	string,
    FROM_RUN	string,
