...
appName = "App_create_staging_table_wh"
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_PRODUCT_WH
  (
    PRODUCT_ID	string,
    PROGRAM_NAME	string,
    PRODUCT_TYPE	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_PRODUCT_FAMILY_WH
  (
    FAMILY_PRODUCT_ID	string,
	FAMILY_NAME      	string,
	SORTING_TYPE     	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_PRODUCT_PART_WH
  (
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_PRODUCT_OVERALL_WH
  (
    PLANT            	string,
	PRODUCT_ID       	string,
	PROGRAM_NAME     	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_JIT_CELL_WH
  (
    JIT_CELL_NO	string,
    LINE_NO	string,
    ROOM	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_DOCUMENT_EER_WH
  (
    PRODUCT_PART_NO	string,
    JIT_CELL_NO	string,
    EERNO	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_MACHINE_WH
  (
    MACHINE_NO             	string,
	MACHINE_NAME           	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_WORK_WEEK_WH
  (
    YEAR         	string,
	QUARTER      	string,
	MONTH        	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_WIP_FA_WH
  (
    PRODUCT_PART_NO   	string,
	RUN_NO            	string,
	OPERATION_NO      	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_WIP_FA_RUNCARD_WH
  (
    PRODUCT_PART_NO	string,
    RUN_NO	string,
    EER_NO	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_WIP_FA_START_OPERATION_WH
  (
    PRODUCT_PART_NO	string,
    EER_NO	string,
    OPERATION_NO	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_WIP_FA_WIP_TRANS_WH
  (
    RUN_NO	string,
    OPERATION_NO	string,
    CYCLE_NO	int,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_ROUTING_OPERATION_WH
  (
    PRODUCT_PART_NO	string,
    EER_NO	string,
    OPERATION_NO	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_OPERATION_WH
  (
    OPERATION_NO	string,
    AREA_NAME	string,
...
spark.sql(
  f""" 
  CREATE OR REPLACE TABLE {iceberg_table}.EIS_RUNCARD_CONVERT_WH
  (
    RUN_NO	string,
    FROM_RUN	string,
