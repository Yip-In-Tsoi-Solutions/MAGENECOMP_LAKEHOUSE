...
appName = "STAGING_DTC_TRANSACTION_RERUN"
...
source_path = f"s3a://staging/DTC/ALL_DTC/rerun/*.txt"
#Destination Table
...
final_df.createOrReplaceTempView(f"STAGING_DTC_TRANSACTION_RERUN")
...
spark.sql(f"""
    ...
    SELECT 
        *
    FROM STAGING_DTC_TRANSACTION_RERUN
""")